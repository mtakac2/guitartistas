# users = AdminUser.create(email: 'guitartistas@gmail.com', password: 'neustart')
...
news = News.create([
  ...
  },
  {
    ...
    content: 'Nor again is there anyone who loves or pursues or desires to obtain 
...
biographies = Biography.create([
  ...
  {
    title:   'Radar Meker',
    content: 'On the other hand, we denounce with righteous indignation and dislike men 
    ...
    the same as saying through shrinking from toil and pain. These cases are perfectly simple 
...
events = Event.create([
  {
    ...
    anim id est laborum.',
    start_time: '2012-12-12 19:00'
  },
  {
    title: 'Another concert',
    description: 'Ut aut reiciendis voluptatibus maiores alias consequatur aut perferendis doloribus asperiores 
    repellat.',
    start_time: '2012-01-05 18:00'
  },
  {
    title: 'And another one',
    description: 'He rejects pleasures to secure other greater pleasures, or else he endures pains to avoid worse 
    pains.',
    start_time: '2012-08-12 20:00'
  }
])

albums = Album.create([
  {
    title: 'Photos from concerts',
  ...
  },
  {
    ...
    description: 'In a free hour, when our power of choice is untrammelled.'
  },
  {
    title: 'Wien',
    description: ''
  ...
  {
    title: 'Instruments',
    description: 'Some instruments.'
  },
  {
    title: 'Random stuff',
    description: 'Just some random bullshit...'
  },
  {
